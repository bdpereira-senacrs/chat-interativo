...
export const quiz = [
  {
    id: 1,
    question: "Quando criança, o que você mais gostava de brincar?",
    options: [
      {
        id: "a",
        courses: [1, 2],
        message:
          "Loja de brinquedos ou fazer planilhas de “clientes” imaginários",
      },
      {
        id: "b",
        courses: [3],
        message:
          "Montar casinhas, organizar móveis e fazer decoração com papel",
      },
      {
        id: "c",
        courses: [4, 5],
        message:
          "Escrever cartinhas, criar “secretarias” ou fingir que era assistente de alguém importante ",
      },
      {
        id: "d",
        courses: [6, 7],
        message:
          "Consertar coisas ou inventar soluções para “problemas” de mentira ",
      },
    ],
  },
  {
    id: 2,
    question:
      "Qual dessas frases mais te representa num dia de trabalho em equipe?",
    options: [
      {
        id: "a",
        courses: [1, 8],
        message: "Deixa comigo, vou organizar o que cada um precisa fazer.",
      },
      {
        id: "b",
        courses: [4, 5],
        message: "Gente, vamos nos ouvir melhor, cada um tem um talento!",
      },
      {
        id: "c",
        courses: [7],
        message: "Eu posso fazer um passo a passo pra ninguém se perder.",
      },
      {
        id: "d",
        courses: [6],
        message: "Enquanto vocês discutem, eu já resolvi três partes aqui!",
      },
    ],
  },
  {
    id: 3,
    question: "Você tem facilidade para… ",
    options: [
      {
        courses: [1, 2],
        id: "a",
        message: "Lidar com números, contas e registros ",
      },
      {
        id: "b",
        courses: [3],
        message:
          "Imaginar novas formas de deixar um ambiente mais bonito e funcional ",
      },
      {
        courses: [6],
        id: "c",
        message: "Usar a tecnologia para resolver problemas ",
      },
      { courses: [5], id: "d", message: "Conversar com todo tipo de gente " },
    ],
  },
  {
    id: 4,
    question: "Qual dessas atividades você escolheria para um sábado à tarde? ",
    options: [
      {
        id: "a",
        courses: [9],
        message:
          "Organizar uma pequena horta ou separar o lixo reciclável direitinho ",
      },
      {
        id: "b",
        courses: [2],
        message: "Fazer uma planilha para organizar as finanças pessoais ",
      },
      {
        courses: [6],
        id: "c",
        message: "Criar um site ou testar um app novo ",
      },
      {
        id: "d",
        courses: [5],
        message:
          "Ajudar um amigo a montar um currículo ou praticar uma entrevista ",
      },
    ],
  },
  {
    id: 5,
    question: "Na sua visão, o ambiente ideal de trabalho é… ",

    options: [
      {
        id: "a",
        courses: [1, 7],
        message: "Um lugar com rotina, processos bem definidos e metas claras ",
      },
      {
        id: "b",
        courses: [3],
        message: "Um espaço criativo, onde posso expressar ideias visualmente ",
      },
      {
        id: "c",
        courses: [4, 10],
        message: "Um ambiente dinâmico, com bastante contato com pessoas ",
      },
      {
        id: "d",
        courses: [11],
        message: "Um espaço técnico, com foco em regras, normas e segurança ",
      },
    ],
  },
  {
    id: 6,
    question: "O que te tira do sério mais rápido? ",

    options: [
      { courses: [8], id: "a", message: "Falta de planejamento " },
      { courses: [3], id: "b", message: "Desorganização visual " },
      { courses: [5], id: "c", message: "Falta de empatia " },
      { courses: [2], id: "d", message: "Falta de lógica nas decisões " },
    ],
  },
  {
    id: 7,
    question: "Se você fosse escrever um e-book, qual seria o tema? ",

    options: [
      { courses: [1, 12], id: "a", message: "Como montar um negócio do zero " },
      {
        courses: [3],
        id: "b",
        message: "Ideias para transformar pequenos espaços ",
      },
      {
        courses: [8],
        id: "c",
        message: "Dicas práticas de organização de estoque ",
      },
      {
        id: "d",
        courses: [5],
        message: "Como desenvolver habilidades emocionais para o trabalho ",
      },
    ],
  },
  {
    ...
    options: [
      {
        courses: [1],
        id: "a",
        message: "Ter estabilidade financeira e reconhecimento ",
      },
      {
        id: "b",
        courses: [10],
        message: "Conquistar autonomia para empreender ou mudar de carreira ",
      },
      {
        id: "c",
        courses: [9],
        message: "Me desenvolver tecnicamente para atuar com propósito ",
      },
      {
        courses: [5],
        id: "d",
        message: "Ajudar outras pessoas a crescer também ",
      },
    ],
  },
  {
    id: 9,
    question: "Qual dessas situações te deixa mais animado(a)? ",
    options: [
      {
        courses: [6, 7],
        id: "a",
        message: "Resolver um desafio lógico ou técnico ",
      },
      {
        courses: [5],
        id: "b",
        message: "Ajudar alguém a resolver um conflito no trabalho ",
      },
      {
        courses: [2],
        id: "c",
        message: "Organizar documentos e deixar tudo certinho ",
      },
      {
        courses: [3],
        id: "d",
        message: "Criar uma apresentação visual impactante ",
      },
    ],
  },
  {
    id: 10,
    question: "Como você reage diante de mudanças? ",
    options: [
      {
        courses: [1, 8],
        id: "a",
        message: "Planejo um plano B, C e D para garantir tudo ",
      },
      {
        id: "b",
        courses: [9],
        message: "Observo, analiso e busco me adaptar com equilíbrio ",
      },
      {
        courses: [6],
        id: "c",
        message: "Fico animado(a) com a possibilidade de inovar ",
      },
      {
        id: "d",
        courses: [5],
        message: "Organizo os impactos e ajudo os outros a entenderem também ",
      },
    ],
  },
  {
    id: 11,
    question: "Qual dessas tarefas você acharia mais legal? ",
    options: [
      {
        id: "a",
        courses: [6],
        message: "Criar um sistema que organiza dados automaticamente ",
      },
      {
        id: "b",
        courses: [8],
        message: "Acompanhar o ciclo de vida de um produto numa empresa ",
      },
      {
        courses: [9],
        id: "c",
        message: "Cuidar da parte ambiental de uma nova construção ",
      },
      {
        id: "d",
        courses: [10],
        message: "Atuar numa imobiliária negociando com diferentes clientes ",
      },
    ],
  },
  {
    ...
    options: [
      { courses: [2, 7], id: "a", message: "Com lógica, passo a passo " },
      {
        id: "b",
        courses: [4],
        message: "Pensando nas pessoas envolvidas e em como comunicar bem ",
      },
      {
        courses: [3],
        id: "c",
        message: "Com criatividade e referências externas ",
      },
      {
        courses: [11],
        id: "d",
        message: "De forma prática, aplicando normas e padrões ",
      },
    ],
  },
  {
    id: 13,
    question: "Como seria o seu “superpoder profissional”? ",
    options: [
      {
        courses: [7, 8],
        id: "a",
        message: "Otimizar tempo e recursos como ninguém ",
      },
      {
        courses: [3],
        id: "b",
        message: "Deixar tudo visualmente agradável e funcional ",
      },
      {
        courses: [5],
        id: "c",
        message: "Ser a ponte entre pessoas e processos ",
      },
      {
        courses: [6],
        id: "d",
        message: "Criar soluções digitais para tarefas repetitivas ",
      },
    ],
  },
  {
    id: 14,
    question: "Qual dessas ideias te parece mais atraente? ",
    options: [
      {
        courses: [7],
        id: "a",
        message: "Criar controles de qualidade para produtos ",
      },
      {
        id: "b",
        courses: [6],
        message: "Automatizar um processo de estoque usando tecnologia ",
      },
      {
        courses: [5],
        id: "c",
        message: "Liderar pessoas num ambiente colaborativo ",
      },
      {
        id: "d",
        courses: [11],
        message: "Ajudar a manter a segurança e o bem-estar de equipes ",
      },
    ],
  },
  {
    id: 15,
    question: "Por fim, como você se vê profissionalmente daqui a 5 anos?",
    options: [
      {
        courses: [1, 10],
        id: "a",
        message: "Gerenciando meu próprio negócio ou equipe ",
      },
      {
        courses: [6, 7],
        id: "b",
        message: "Sendo referência técnica na área que escolhi ",
      },
      {
        courses: [3, 9],
        id: "c",
        message: "Atuando com criatividade e propósito ",
      },
      {
        courses: [2, 5],
        id: "d",
        message: "Com uma carreira estável e crescendo aos poucos ",
      },
    ],
  },
];
